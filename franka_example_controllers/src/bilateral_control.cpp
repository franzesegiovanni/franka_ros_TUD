...
int main(int argc, char **argv)
{
  ...
  ros::Publisher  pub_right = node_position.advertise<geometry_msgs::PoseStamped>("/equilibrium_pose_right", 1000);

  ros::Publisher  pub_left =  node_position.advertise<geometry_msgs::PoseStamped>("/equilibrium_pose_left", 1000); 
